...
public class GoblinAttackState : EnemyStateAttack
{
    ...
    public GoblinAttackState(
        Enemy enemy,
        GoblinAIController ai)
    ...
    public override void OnEnter()
    {
        ...
        Debug.Log(
            $"[{enemy.name}] Goblin Attack ENTER");
    }
    ...
    protected override void PerformAttack()
    {
        ...
        Debug.Log(
            $"[Goblin] ATAQUE -> {ai.CurrentTarget.name}");
